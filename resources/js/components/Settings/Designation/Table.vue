...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? i18n.t('card_title.add_designation') : i18n.t('card_title.edit_designation')
        },
    },
