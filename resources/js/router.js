...
import MinorDashboard from "./components/minorDashboard/MinorDashboard";
import VendorDashboard from "./components/layouts/widgets/VendorDashboard";
    ...
    routes: [
        ...
        },
        {
            ...
            beforeEnter: async (to, from, next) => {
                await logMe(to, from);
                if (localStorage.getItem("isLoggedIn") === "true") {
                    await store.dispatch('home/getDashboardData');
                    next();
                } else {
                    next("login");
                }
        ...
        },
        {
            ...
            beforeEnter: async (to, from, next) => {
                store.state.home.dashboard_tab='request';
                await logMe(to, from);
                next();
            },
        },
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_category"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_category"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") + " / " + i18n.t("product_attribute_groups"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.add_product_attribute_group"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.edit_product_attribute_group"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.add_product_attribute"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.edit_product_attribute"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.add_product_variant"),
        ...
        },
        {
            ...
            name:
                i18n.t("product") +
                " / " +
                i18n.t("card_title.edit_product_variant"),
        ...
        },
        {
            ...
            name:
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_mail_setting"),
        ...
        },
        {
            ...
            name:
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_sms_setting"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_department"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_department"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_designation"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_designation"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_fiscal_year"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_fiscal_year"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_mail_template"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_signature"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_signature"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.add_signature_use_department"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("settings") +
                " / " +
                i18n.t("card_title.edit_signature_use_department"),
        ...
        },
        {
            ...
            name: i18n.t("my") + " " + i18n.t("products"),
             component: VendorMyProducts,
            beforeEnter: async (to, from, next) => {
                await logMe(to, from);
                next();
            },
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.add_budget_limit"),
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.edit_budget_limit"),
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.add_budget_request"),
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.edit_budget_request"),
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.add_freeze_budget"),
        ...
        },
        {
            ...
            name:
                i18n.t("budget") +
                " / " +
                i18n.t("card_title.edit_freeze_budget"),
        ...
        },
        {
            ...
            name:
                ...
                i18n.t("Account") +
                " / " +
                i18n.t("card_title.add_bank_account_transaction"),
...

        {
            ...
            beforeEnter: async (to, from, next) => {
                store.state.home.dashboard_tab='quote';
                await logMe(to, from);
                next();
            },
        },
...

        {
            ...
            beforeEnter: async (to, from, next) => {
                store.state.home.dashboard_tab='order'
                await logMe(to, from);
                next();
            },
        },
...

        {
            ...
            beforeEnter: async (to, from, next) => {
                store.state.home.dashboard_tab='invoice';
                await logMe(to, from);
                next();
            },
        },
